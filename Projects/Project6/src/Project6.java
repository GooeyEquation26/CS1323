...
public class Project6 {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		while (continuePlaying.equalsIgnoreCase("yes")) {
			...
			//prints the number of guesses needed
			int numGuesses = numberOfGuesses(word, scrambledWord, keyboard);
			...
			//prints end of game data NOTE: no return
			scoreboard(pointsEarned, wordPoints, word);
	...
	public static int numberOfGuesses(String word, String scrambledWord, Scanner keyboard) {
	...
	public static void scoreboard(int pointsEarned, int wordPoints, String word) {
